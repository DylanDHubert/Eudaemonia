  ...
  try {
    ...
    const { data: entry, error: entryError } = await supabase
      ...
      .insert({
        ...
        alcohol_units: alcoholUnits !== undefined && alcoholUnits !== null && alcoholUnits !== '' ? parseFloat(alcoholUnits) : null,
        cannabis_amount: cannabisAmount !== undefined && cannabisAmount !== null && cannabisAmount !== '' ? parseFloat(cannabisAmount) : null,
        meditation,
