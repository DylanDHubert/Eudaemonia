  ...
  try {
    ...
    const { data: updatedEntry, error: updateError } = await supabase
      ...
      .update({
        ...
        cannabis_amount: body.cannabisAmount !== undefined ? (body.cannabis !== undefined && body.cannabis ? (body.cannabisAmount !== null && body.cannabisAmount !== '' ? parseFloat(body.cannabisAmount) : 0) : null) : existingEntry.cannabis_amount,
